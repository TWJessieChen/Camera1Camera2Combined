...
public class MyBaseEncoder {
    ...
    public interface MyEncoderCallBackFunction {
        ...
        void encodeAudioSuccess(byte[] encodeDate, int encodeSize, int channelCount, int sampleBit,
                int sampleRate);
        void encodeVideoSuccess(byte[] encodeDate, int encodeSize, boolean isVideoKeyFrame,
