package com.gmail.b09302083.android_camera_example.encoder;
...
public class MyVideoEncoder extends MyBaseEncoder{
    ...
    public MyVideoCodecWrapper prepareVideoEncoder(int width, int height , int bitRate, String saveFileName , boolean isMainStreaming) throws
            Exception {
...
*/
                ...
                int height = myMediaCodecWrapper.mediaCodec.getOutputFormat().getInteger(
